...
<div class="form-group">
      ...
      <div class="col-sm-10">
        <form:input type="email" name="email" class="form-control" style="background-color:orange;color:snow" path="emailid" placeholder="Your Email Address" required="true" ></form:input>
      </div>
    </div>
       <div class="form-group">
      <form:label class="control-label col-sm-2" path="password" style="color:snow">Password:</form:label>
      <div class="col-sm-10">          
        <form:input type="password" name="password" class="form-control" style="background-color:orange;color:snow" path="password" placeholder="Enter Password" required="true" pattern=".{4,15}" title="password should contain 4 to 15 characters"></form:input>
      </div>
    </div>
                <div class="form-group">        
