...
<h2 class="text-center" style="color:snow">Signup with SuPraNita</h2>
 ...
 <div class="form-group">
      ...
      <div class="col-sm-10">
        <form:input type="email" class="form-control" path="email" placeholder="Your Email Address" style="background-color:orange;color:snow" required="true"></form:input>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <form:input type="password" class="form-control" path="pwd" placeholder="Choose Password" style="background-color:orange;color:snow" required="true" pattern=".{4,15}" title="password should contain 4 to 15 characters"></form:input>
      </div>
    </div>
    
     <div class="form-group">
      <form:label class="control-label col-sm-2" path="mobileNo" style="color:snow">Mobile Number:</form:label>
      <div class="col-sm-10">          
        <form:input type="tel" class="form-control" path="mobileNo" placeholder="Mobile Number(For Order Status Updates)" style="background-color:orange;color:snow" required="true" title="please enter valid contact number" pattern="^\d{10}$"></form:input>
      </div>
    </div>
